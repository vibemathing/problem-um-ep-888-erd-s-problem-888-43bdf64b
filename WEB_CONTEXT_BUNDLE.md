...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-888-erd-s-problem-888-43bdf64b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-888"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-888-erd-s-problem-888-43bdf64b-v1",
      "problem_contract_sha256": "3c0e3860d331e7b324918fcb3e98681d4d9294aa88f4423344fc6e9535cd7424",
      "problem_id": "problem:um-ep-888-erd-s-problem-888-43bdf64b",
      "route_id": "route:um-ep-888-erd-s-problem-888-43bdf64b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-888-erd-s-problem-888-43bdf64b-source-fidelity-01",
      "graph_id": "graph:um-ep-888-erd-s-problem-888-43bdf64b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-888-erd-s-problem-888-43bdf64b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-888-erd-s-problem-888-43bdf64b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the size of the largest $A\\subseteq \\{1,\\ldots,n\\}$ such that if $a\\leq b\\leq c\\leq d\\in A$ are such that $abcd$ is a square then $ad=bc$?"
          },
          "statement_sha256": "8fb16e270d96f5323da0badd25324f65b41d949cfff4cb310768b2ba5e190837"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-888-erd-s-problem-888-43bdf64b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-888-erd-s-problem-888-43bdf64b-root",
      "route_id": "route:um-ep-888-erd-s-problem-888-43bdf64b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-888-617ca4e6a139",
        "url": "https://www.unsolvedmath.com/problems/EP-888"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
